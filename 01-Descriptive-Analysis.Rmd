...
以下依據各議題展示分析架構與程式碼撰寫，針對每一問題先瞭解運輸資料的特性，而後再依據分析邏輯撰寫程式碼。
...
<span style="font-size:15pt">**•  <u>統計所有主路線數 </u>**</span>   
...
<span style="font-size:15pt">**• <u>統計各主路線擁有的子路線數</u>**</span>  
...
<span style="font-size:15pt">**• <u>羅列各主路線含括的子路線</u>**</span>  
...
<span style="font-size:15pt">**• <u>尋找公車支線</u>**</span>  
...
<span style="font-size:15pt">**• <u>統計各子路線總站牌數</u>**</span>  
...
<span style="font-size:15pt">**• <u>整理同一站名的所有路線</u>**</span>  
分析流程彙整如下：  
...
<span style="font-size:15pt">**• <u>尋找公車環狀線</u>**</span>  
...
# 擷取公車站間距離資料中站序間的所有資料
# 請務必注意sqid_o必須加一！
temp=filter(bus_distance, SubRouteUID=="HSZ000701", Sequence>=sqid_o+1, Sequence<=sqid_d)
