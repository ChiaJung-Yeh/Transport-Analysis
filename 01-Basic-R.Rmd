...
matrix_operation=data.frame(TYPE=rep(c("橫列","直行"), each=2), sum=c("`rowSums(mat2)`", paste(rowSums(mat2), collapse=" "), "`colSums(mat2)`", paste(colSums(mat2), collapse=" ")), ave=c("`rowMeans(mat2)`", paste(rowMeans(mat2), collapse=" "), "`colMeans(mat2)`", paste(colMeans(mat2), collapse=" ")))
