...
temp=data.frame(fun=c('`month(月份向量)`','`month(月份向量, label=T, locale="en")`','`month(月份向量, label=T, abbr=F, locale="en")`','`month(月份向量, label=T, locale="zh_TW.UTF-8")`','`wday(日期向量)`','`wday(日期向量, week_start=1)`','`wday(日期向量, label=T, locale="en")`','`wday(日期向量, label=T, abbr=F, locale="en")`','`wday(日期向量, label=T, locale="zh_TW.UTF-8")`','`wday(日期向量, label=T, abbr=F, locale="zh_TW.UTF-8")`'),
