...
geom_set=data.frame(setting=c("`color=`","`width=`","`box.color=`","`box.size=`"), description=c("設定文字和外圍方框的顏色，若要去除外框，可直接設定`color=NA`", "標籤的總寬度"," 外圍方框的顏色", "外圍方框的粗細"), function1=c("V","X","X","X"), function2=c("V","V","V","V"))
...
1`表示靠右對齊，詳請參見表\@ref(tab:font-angle-just-tab)。
