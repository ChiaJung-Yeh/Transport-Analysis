...
### 桑基圖
桑基圖（Sankey Diagram）可用以表達各階層的流動，


```{r geom-Sankey-eg1, echo=F, eval=T, out.width="70%", fig.align="center", warning=F}
scmig=read.csv("https://raw.githubusercontent.com/ChiaJung-Yeh/Transport-Analysis/master/Data/social_migration.csv")
melt(scmig, id.vars="X", measure.vars=c)
...
```{r geom-Sankey-eg2, echo=F, eval=T, out.width="70%", fig.align="center", warning=F}
scmig=read.csv("https://raw.githubusercontent.com/ChiaJung-Yeh/Transport-Analysis/master/Data/social_migration.csv")
scmig=melt(scmig, id.vars="X", measure.vars=2:7, variable.names="TO", value.name="People")
